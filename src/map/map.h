...
enum status_point_types { //we better clean up this enum and change it name [Hemagx]
	...
	SP_STR2,SP_AGI2,SP_VIT2,SP_INT2,SP_DEX2,SP_LUK2, // 2063-2068, base stat + bonuses
	SP_SKILLDAMAGE, SP_SPELLDAMAGE, SP_CASTSPEED, SP_STATUSRESIST, SP_BASICDAMAGE, SP_BASEHP, SP_APS, SP_CDEXPIRATION,// 2069-2076
	SP_DEBUFFOTHER,SP_BUFFOTHER,SP_BUFFSELF,SP_POISONDMG,SP_BLEEDDMG,SP_IGNITEDMG,SP_SKILLBOOST,SP_MAGTOATK,SP_ATKTOMAG,//2077-2085
	SP_NOCRITS, SP_CRITEFFECT, SP_SCADDEDDAMAGE, SP_INSTANTKILL, SP_NECROMANCY, SP_STATUSEFFECT, SP_CULLINGSTRIKE, // 2086-2092
	SP_HEALAVOID, SP_MEDUSA, SP_SKILLCRIT, SP_EQUIPRESTRICTION, SP_CRITICALEVADE, SP_IGNORECOOLDOWN, SP_SKILLBOOST2, // 2093-2099
